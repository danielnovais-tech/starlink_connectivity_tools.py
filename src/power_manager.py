...
class PowerManager:
    ...
    def schedule_sleep_cycle(self, active_duration: int, sleep_duration: int):
        ...
        logger.info(f"Sleep cycle scheduled: {active_duration}s active, {sleep_duration}s sleep")
