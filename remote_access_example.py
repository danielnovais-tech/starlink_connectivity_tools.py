"""
Starlink Remote Access Example using Cookies

This script demonstrates how to access Starlink devices remotely using cookies
for authentication. It retrieves account information, service lines, dish status,
and router/WiFi information.

Requirements:
    - cookies.json file with authentication cookies
    - starlink_client library installed
"""
...
if __name__ == "__main__":
    ...
    for dish in sl.content.get_dishes():
        ...
        print(f"Dish Serial: {dish.serialNumber}")
        dish_id = dish.get_id()
        try:
        ...
        for router in dish.routers:
            ...
            print(f"Software Version: {status.device_info.software_version}")
            print("Networks: ")
